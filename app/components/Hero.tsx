...
const Hero = () => {
  return (
    <main className='relative items-center h-full mt-[112px] ml-[50px] lg:ml-[100px] lg:max-w-[900px] lg:mt-[130px]'>
      ...
      <p className='max-w-[363px] lg:max-w-[773px] text-[14px] lg:text-[24px] mb-[20px]'>
